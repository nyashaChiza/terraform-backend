...
def build_prompt_lite(
    *,
    ...
    return (
        ...
        "- title MUST specifically name the primary muscle groups or training focus of THIS session's exercises (e.g. 'Back & Bicep Pull Day', 'Leg Power & Core', 'Push: Chest & Shoulders', 'Upper Body Strength'). NEVER use generic titles like 'Full Body Workout', 'Strength Training', 'Cardio Session', or any title that could apply to any session\n\n"
